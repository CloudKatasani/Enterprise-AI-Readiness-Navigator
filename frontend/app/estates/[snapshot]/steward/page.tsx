import { ApiDownNotice, EvidenceItem, Metric } from "@/components/ui";
import { ApiUnavailable, stewardView } from "@/lib/api";

export const dynamic = "force-dynamic";

export default async function EstateStewardPage({
  params,
}: {
  ...
  let view;
  try {
    view = await stewardView(snapshot);
  } catch (error) {
